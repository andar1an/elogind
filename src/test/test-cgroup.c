...
#else // 0
        ASSERT_OK_GE(r, 0);
        ASSERT_OK_GE(cg_create(SYSTEMD_CGROUP_CONTROLLER, test_a), 0);
        ASSERT_OK_GE(cg_create(SYSTEMD_CGROUP_CONTROLLER, test_b), 0);
        ASSERT_OK_GE(cg_create(SYSTEMD_CGROUP_CONTROLLER, test_c), 0);
#endif // 0
